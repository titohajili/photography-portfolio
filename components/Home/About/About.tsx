...
const About = () => {
  return (
    <div className='mt-[168px] mb-16 flex items-center justify-center'>
      <div className='flex'>
        <div className='bg-black w-[600px] h-[350px] flex items-center justify-center mr-6'>
        ...
        <div className='flex flex-col ml-6'>
          ...
          <div className='w-[450px]'>
            <p className='mb-3 leading-8 text-gray-400'>Hi! I'm Tito Hajili, an award-winning photographer with years of experience under my belt. Entrust with me any of your special occasions to make them the most memorable.</p>
            <p className='pt-2 leading-8 text-gray-400'>I am passionate about creating extraordinary stories, gorgeous portraits, professional photo sessions, and much more. Feel free to hire me for your significant event!</p>
          </div>
